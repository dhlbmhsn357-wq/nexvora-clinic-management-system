            ...
            {activePatients.length === 0 ? (
              ...
              <div className="divide-y divide-border">
                {activePatients.map((p, idx) => {
                  ...
                  return (
                    <div key={p.id} className={`grid grid-cols-1 md:grid-cols-[auto_minmax(12rem,1.2fr)_7rem_7rem_auto_auto] items-center gap-4 px-6 py-4 transition-colors hover:bg-muted/10 ${p.status === "in-consultation" ? "bg-primary/5" : ""}`}>
                      ...
                      <div className="w-28 text-center justify-self-center">
